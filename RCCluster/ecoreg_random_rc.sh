...
#SBATCH -t 6-23:59
#SBATCH -o /n/home07/swoodward/STAN_ecoreg/test2_error.out #specify where to save errors returned by the program
#SBATCH -e /n/home07/swoodward/STAN_ecoreg/test2_log.err #specify where to save the output log
...
#SBATCH -J fit96.random  #job name
...
R CMD BATCH --quiet --no-restore --no-save ecoreg_random_rc.R /n/home07/swoodward/STAN_ecoreg/test2_${SLURM_ARRAY_TASK_ID}.Rout
