...
#SBATCH -t 6-23:59
#SBATCH -o /n/home07/swoodward/STAN_ecoreg/test4_error.out #specify where to save errors returned by the program
#SBATCH -e /n/home07/swoodward/STAN_ecoreg/test4_log.err #specify where to save the output log
...
#SBATCH -J fit192.random  #job name
...
R CMD BATCH --quiet --no-restore --no-save ecoreg_random_rc_192strata.R /n/home07/swoodward/STAN_ecoreg/test4_${SLURM_ARRAY_TASK_ID}.Rout
