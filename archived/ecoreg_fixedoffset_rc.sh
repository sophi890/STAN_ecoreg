...
#SBATCH -J fit.fixedoffsets  #job name
...
R CMD BATCH --quiet --no-restore --no-save ecoreg_fixedoffset_rc.R /n/home07/swoodward/STAN_ecoreg/test_${SLURM_ARRAY_TASK_ID}.Rout
