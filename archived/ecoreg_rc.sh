...
#SBATCH -t 3-23:00
#SBATCH -o /n/home07/swoodward/STAN_ecoreg/test_error.out #specify where to save errors returned by the program
#SBATCH -e /n/home07/swoodward/STAN_ecoreg/test_log.err #specify where to save the output log
...
R CMD BATCH --quiet --no-restore --no-save ecoreg_rc.R /n/home07/swoodward/STAN_ecoreg/test_${SLURM_ARRAY_TASK_ID}.Rout
