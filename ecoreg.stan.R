...
## Testing loglik function - yes this matches Jackson's! Although here I drop the binomial coeffs for simplicity.
expose_stan_functions(stanmodel = 'ecoreg.stan')
loglikeco_log(y = y, numcounties = 3082, numeffects = c(62, 6, 3), numcats = c(2,2,2,8,2,3), covlist = covlist.pm25, adata = adata, whicha = whicha, pars = rep(0, 78)) #-218254980  
loglikeco_log(y = y, numcounties = 3082, numeffects = c(62, 6, 3), numcats = c(2,2,2,8,2,3), covlist = covlist.pm25, adata = adata, whicha = whicha, pars = rep(-0.1, 78)) #-1241791
loglikeco_log(y = y, numcounties = 3082, numeffects = c(62, 6, 3), numcats = c(2,2,2,8,2,3), covlist = covlist.pm25, adata = adata, whicha = whicha, pars = rep(0.1, 78)) #-3076026276
